...
Создание коробки для хранения целого числа, создание коробки для хранения строки, извлечение объекта из выбранной коробки, просмотр состояния всех созданных коробок: пустая, заполнена, тип содержимого, поиск максимального числа среди всех числовых коробок, выход из программы.

Особенности реализации:

Все созданные коробки хранятся в списке allBoxes, пользователь может выбрать любую коробку по индексу для извлечения содержимого, поиск максимального числа осуществляется динамически: метод проходит по всем коробкам, проверяет, является ли содержимое числом, и вычисляет максимум с использованием doubleValue().

<img width="450" height="590" alt="image" src="https://github.com/user-attachments/assets/2a6fbf8a-91aa-4e01-bb66-fa24c362a88e" />

<img width="448" height="659" alt="image" src="https://github.com/user-attachments/assets/77d2d537-2b93-4800-91cf-438984cb5c41" />

<img width="448" height="287" alt="image" src="https://github.com/user-attachments/assets/8bbe8841-c1fb-4f89-a6cd-0924b6b375f9" />
...
<img width="444" height="123" alt="image" src="https://github.com/user-attachments/assets/757fbf07-a955-4bf3-b4d5-c80c1cfa0c78" />
...
<img width="636" height="148" alt="image" src="https://github.com/user-attachments/assets/645e1049-0d38-4c46-b92c-2050bb183d81" />
...
<img width="489" height="117" alt="image" src="https://github.com/user-attachments/assets/4e0c3e8d-4b85-4383-8c74-0024e443f4cc" />
...
<img width="721" height="159" alt="image" src="https://github.com/user-attachments/assets/a96dd28d-418d-43ae-9d87-b210a75f2f36" />
